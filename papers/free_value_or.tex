...
The Beman reference nullables opt in through explicit integration headers.
The core header neither probes the include path for those optional
dependencies nor includes them implicitly. This is a packaging boundary of
the reference implementation; the proposed standard-library specializations
remain beside their types in the \tcode{<optional>} and \tcode{<expected>}
header synopses below.
