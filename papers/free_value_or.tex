...
This is a simplification, and the second of the two open questions below.
The alternative,
...
\item whether an rvalue nullable should move its payload. As specified it
  ...
  \tcode{or_construct} the same. Moving costs a return type that depends on
  the value category of the nullable (see Design).
\end{itemize}
